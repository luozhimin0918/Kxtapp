...
public class GsonRequest<T> extends Request<T> {
	...
	// 接受实际的T
	// 自己添加构造方法必须要复写
	public GsonRequest(int method, String url, Map<String, String> map,
	...
	// 自己添加构造方法必须要复写
	public GsonRequest(int method, String url, Response.Listener listener,
			Response.ErrorListener errolistener) {
		// 这里的listener是error信息的返回
