...
public class GWActivity extends Activity {
	...
	private LinearLayout gw_zt_color;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gw_zt_color = (LinearLayout) findViewById(R.id.gw_zt_color);
		if (Isyj) {
			gw_zt_color.setBackgroundColor(Color.parseColor("#04274c"));
		} else {
			gw_zt_color.setBackgroundColor(Color.parseColor("#116bcc"));
		}
		webView = (WebView) findViewById(R.id.webView1);
		String uri = "http://www.kuaixun360.com/";
