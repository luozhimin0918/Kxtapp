...
public class LinkuserActivity extends Activity {
	...
	private LinearLayout linkuser_zt_color;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.link_users);
		
		linkuser_zt_color=(LinearLayout) findViewById(R.id.linkuser_zt_color);
		if (Isyj) {
			linkuser_zt_color.setBackgroundColor(Color.parseColor("#04274c"));
		} else {
			linkuser_zt_color.setBackgroundColor(Color.parseColor("#116bcc"));
		}
