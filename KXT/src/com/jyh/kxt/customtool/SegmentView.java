...
public class SegmentView extends LinearLayout {
	...
	private void init() {
		...
		textView2.setLayoutParams(new LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 1));
		textView3.setLayoutParams(new LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 1));

		textView1.setText("数据");
		textView2.setText("事件");
		textView3.setText("假期");
	 ...
	 * @author RANDY.ZHANG
	 */
	public void setCurtunSegment(int position) {
		switch (position) {
		case 0:
			if (textView1.isSelected()) {
				return;
	...
	public void setListener(onSegmentViewClickListener listener) {

		this.listener = listener;
	}

	public void changeBackGruond(boolean isYj) {

		if (isYj) {
			xrp = getResources().getXml(
					R.drawable.seg_text_color_selector_night);
			try {
				...
				textView1.setBackgroundResource(R.drawable.seg_left_night);
				textView2.setBackgroundResource(R.drawable.seg_center_night);
				textView3.setBackgroundResource(R.drawable.seg_right_night);
			} catch (Exception e) {
